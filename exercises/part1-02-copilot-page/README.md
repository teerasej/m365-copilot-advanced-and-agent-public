...
3. จากนั้นใช้ Copilot ช่วยเพิ่มเนื้อหาโดยการพิมพ์ `/` เพื่อเรียก Copilot ใน Page แล้วใส่ Prompt:
...
> ⚠️ **หมายเหตุ:** ฟีเจอร์การเรียก Copilot ด้วย `/` ภายใน Page ต้องการ M365 Copilot License เต็มรูปแบบ

---

## Feature 3: แชร์ Copilot Page ให้เพื่อนร่วมทีม

1. จากหน้า Copilot Page ให้กดปุ่ม **Share** ที่มุมขวาบน

2. ใส่ชื่อหรืออีเมลของเพื่อนร่วมทีมที่ต้องการแชร์ด้วยกัน

3. เลือกสิทธิ์เป็น **Can edit** เพื่อให้เพื่อนสามารถแก้ไขและเพิ่มเนื้อหาได้

4. กดปุ่ม **Send** หรือคัดลอก Link แล้วส่งให้เพื่อน

5. เมื่อเพื่อนเข้ามาใน Page เดียวกัน ทุกคนสามารถแก้ไขเนื้อหาได้พร้อมกันแบบ real-time
